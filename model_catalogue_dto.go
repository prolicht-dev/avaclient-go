...
type CatalogueDto struct {
	...
	CatalogueTypeDetail *string `json:"catalogueTypeDetail,omitempty"`
}
...
// GetCatalogueTypeDetail returns the CatalogueTypeDetail field value if set, zero value otherwise.
func (o *CatalogueDto) GetCatalogueTypeDetail() string {
	if o == nil || IsNil(o.CatalogueTypeDetail) {
		var ret string
		return ret
	}
	return *o.CatalogueTypeDetail
}

// GetCatalogueTypeDetailOk returns a tuple with the CatalogueTypeDetail field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CatalogueDto) GetCatalogueTypeDetailOk() (*string, bool) {
	if o == nil || IsNil(o.CatalogueTypeDetail) {
		return nil, false
	}
	return o.CatalogueTypeDetail, true
}
...
// SetCatalogueTypeDetail gets a reference to the given string and assigns it to the CatalogueTypeDetail field.
func (o *CatalogueDto) SetCatalogueTypeDetail(v string) {
	o.CatalogueTypeDetail = &v
}
...
func (o CatalogueDto) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.CatalogueTypeDetail) {
		toSerialize["catalogueTypeDetail"] = o.CatalogueTypeDetail
	}

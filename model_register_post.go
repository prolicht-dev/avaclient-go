...
type RegisterPost struct {
	...
	ServiceLoginRedirectUri *string  `json:"serviceLoginRedirectUri,omitempty"`
}
...
// GetServiceLoginRedirectUri returns the ServiceLoginRedirectUri field value if set, zero value otherwise.
func (o *RegisterPost) GetServiceLoginRedirectUri() string {
	if o == nil || IsNil(o.ServiceLoginRedirectUri) {
		var ret string
		return ret
	}
	return *o.ServiceLoginRedirectUri
}

// GetServiceLoginRedirectUriOk returns a tuple with the ServiceLoginRedirectUri field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RegisterPost) GetServiceLoginRedirectUriOk() (*string, bool) {
	if o == nil || IsNil(o.ServiceLoginRedirectUri) {
		return nil, false
	}
	return o.ServiceLoginRedirectUri, true
}
...
// SetServiceLoginRedirectUri gets a reference to the given string and assigns it to the ServiceLoginRedirectUri field.
func (o *RegisterPost) SetServiceLoginRedirectUri(v string) {
	o.ServiceLoginRedirectUri = &v
}
...
func (o RegisterPost) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ServiceLoginRedirectUri) {
		toSerialize["serviceLoginRedirectUri"] = o.ServiceLoginRedirectUri
	}

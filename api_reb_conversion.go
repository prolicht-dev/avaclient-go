 ...
 * @param "RebFile" (optional.Interface of *os.File) -  The input file
@return ProjectDto
*/
func (a *RebConversionApiService) RebConversionConvertToAva(ctx _context.Context, localVarOptionals *RebConversionConvertToAvaOpts) (ProjectDto, *_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/conversion/reb/ava"
	...
	localVarFormFileName = "rebFile"
	var localVarFile *os.File
	if localVarOptionals != nil && localVarOptionals.RebFile.IsSet() {
		localVarFileOk := false
		localVarFile, localVarFileOk = localVarOptionals.RebFile.Value().(*os.File)
		if !localVarFileOk {
			return localVarReturnValue, nil, reportError("rebFile should be *os.File")
		}
	}
	if localVarFile != nil {
...
type RebConversionConvertToExcelOpts struct {
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *RebConversionConvertToExcelOpts - Optional Parameters:
...
@return *os.File
*/
func (a *RebConversionApiService) RebConversionConvertToExcel(ctx _context.Context, localVarOptionals *RebConversionConvertToExcelOpts) (*os.File, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/conversion/reb/excel"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
...
type RebConversionConvertToGaebOpts struct {
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *RebConversionConvertToGaebOpts - Optional Parameters:
...
@return *os.File
*/
func (a *RebConversionApiService) RebConversionConvertToGaeb(ctx _context.Context, localVarOptionals *RebConversionConvertToGaebOpts) (*os.File, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/conversion/reb/gaeb"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
...
type RebConversionConvertToOenormOpts struct {
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *RebConversionConvertToOenormOpts - Optional Parameters:
...
@return *os.File
*/
func (a *RebConversionApiService) RebConversionConvertToOenorm(ctx _context.Context, localVarOptionals *RebConversionConvertToOenormOpts) (*os.File, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/conversion/reb/oenorm"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}

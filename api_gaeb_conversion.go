...
type ApiGaebConversionConvertToAvaRequest struct {
	...
	allowLumpSumItemsWithDifferingQuantities  *bool
	gaebFile                                  *os.File
}
...
func (r ApiGaebConversionConvertToAvaRequest) AllowLumpSumItemsWithDifferingQuantities(allowLumpSumItemsWithDifferingQuantities bool) ApiGaebConversionConvertToAvaRequest {
	r.allowLumpSumItemsWithDifferingQuantities = &allowLumpSumItemsWithDifferingQuantities
	return r
}
...
func (a *GaebConversionApiService) GaebConversionConvertToAvaExecute(r ApiGaebConversionConvertToAvaRequest) (*ProjectDto, *http.Response, error) {
	...
	if r.allowLumpSumItemsWithDifferingQuantities != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "AllowLumpSumItemsWithDifferingQuantities", r.allowLumpSumItemsWithDifferingQuantities, "")
	}
...
func (r ApiGaebConversionConvertToExcelRequest) IncludeArticleNumbers(includeArticleNumbers bool) ApiGaebConversionConvertToExcelRequest {
...
// Defaults to &#39;false&#39;. By default, the GAEB standard requires lump sum items (&#39;Pauschalpositionen&#39; in German) to have a quantity of exactly 1. AVACloud does enforce this convention, but if you set this property to &#39;true&#39;, then differing quantities will be kept during the import.
func (r ApiGaebConversionConvertToExcelRequest) AllowLumpSumItemsWithDifferingQuantities(allowLumpSumItemsWithDifferingQuantities bool) ApiGaebConversionConvertToExcelRequest {
	r.allowLumpSumItemsWithDifferingQuantities = &allowLumpSumItemsWithDifferingQuantities
	return r
}
...
type ApiGaebConversionConvertToFlatAvaRequest struct {
	ctx                                       context.Context
	ApiService                                *GaebConversionApiService
	supportSkippedItemNumberLevelsInPositions *bool
	outputHtmlAsXml                           *bool
...
// Defaults to &#39;false&#39;. This controls if, when deserializing GAEB files, skipped levels in position item numbers should be supported. For example, if an ItemNumberSchema defines three levels - two group levels and one position level - but the ItemNumber of the position is just &#39;01.02&#39;, then it will be displayed as &#39;01.__.02&#39; if this is set to true.
func (r ApiGaebConversionConvertToFlatAvaRequest) SupportSkippedItemNumberLevelsInPositions(supportSkippedItemNumberLevelsInPositions bool) ApiGaebConversionConvertToFlatAvaRequest {
	r.supportSkippedItemNumberLevelsInPositions = &supportSkippedItemNumberLevelsInPositions
	return r
}

// Defaults to &#39;false&#39;. If this is enabled, then Html text will be output as XML in the output. This means that e.g. void Html tags will always be output with their closing tag, e.g. it will produce &#39;&lt;br /&gt;&#39; instead of &#39;&lt;br&gt;&#39;.
func (r ApiGaebConversionConvertToFlatAvaRequest) OutputHtmlAsXml(outputHtmlAsXml bool) ApiGaebConversionConvertToFlatAvaRequest {
	r.outputHtmlAsXml = &outputHtmlAsXml
	return r
}

// Defaults to &#39;false&#39;. If this is enabled, then Html text that is empty will be kept in the output. Otherwise, Html text without any plain text will be removed. This is useful for example if you want to keep texts that only consist of empty paragraphs in the output.
func (r ApiGaebConversionConvertToFlatAvaRequest) KeepEmptyHtmlText(keepEmptyHtmlText bool) ApiGaebConversionConvertToFlatAvaRequest {
	r.keepEmptyHtmlText = &keepEmptyHtmlText
	return r
}

// Defaults to &#39;false&#39;. If this is enabled, then the ItemNumber of positions will be in uppercase format if the source file has them. By default, all item numbers will be converted to lowercase, but this option will enable the option to support uppercase item numbers as well.
func (r ApiGaebConversionConvertToFlatAvaRequest) AllowUpperCaseItemNumbers(allowUpperCaseItemNumbers bool) ApiGaebConversionConvertToFlatAvaRequest {
	r.allowUpperCaseItemNumbers = &allowUpperCaseItemNumbers
	return r
}

// Defaults to &#39;false&#39;. By default, the GAEB standard requires lump sum items (&#39;Pauschalpositionen&#39; in German) to have a quantity of exactly 1. AVACloud does enforce this convention, but if you set this property to &#39;true&#39;, then differing quantities will be kept during the import.
func (r ApiGaebConversionConvertToFlatAvaRequest) AllowLumpSumItemsWithDifferingQuantities(allowLumpSumItemsWithDifferingQuantities bool) ApiGaebConversionConvertToFlatAvaRequest {
	r.allowLumpSumItemsWithDifferingQuantities = &allowLumpSumItemsWithDifferingQuantities
	return r
}

// The input file
func (r ApiGaebConversionConvertToFlatAvaRequest) GaebFile(gaebFile *os.File) ApiGaebConversionConvertToFlatAvaRequest {
	r.gaebFile = gaebFile
	return r
}

func (r ApiGaebConversionConvertToFlatAvaRequest) Execute() (*FlatAvaProject, *http.Response, error) {
	return r.ApiService.GaebConversionConvertToFlatAvaExecute(r)
}

/*
GaebConversionConvertToFlatAva Converts GAEB files to Dangl.AVA projects

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiGaebConversionConvertToFlatAvaRequest
*/
func (a *GaebConversionApiService) GaebConversionConvertToFlatAva(ctx context.Context) ApiGaebConversionConvertToFlatAvaRequest {
	return ApiGaebConversionConvertToFlatAvaRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *GaebConversionApiService) GaebConversionConvertToFlatAvaExecute(r ApiGaebConversionConvertToFlatAvaRequest) (*FlatAvaProject, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "GaebConversionApiService.GaebConversionConvertToFlatAva")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/conversion/gaeb/flat-ava"
...
// Defaults to &#39;false&#39;. By default, the GAEB standard requires lump sum items (&#39;Pauschalpositionen&#39; in German) to have a quantity of exactly 1. AVACloud does enforce this convention, but if you set this property to &#39;true&#39;, then differing quantities will be kept during the import.
func (r ApiGaebConversionConvertToGaebRequest) AllowLumpSumItemsWithDifferingQuantities(allowLumpSumItemsWithDifferingQuantities bool) ApiGaebConversionConvertToGaebRequest {
	r.allowLumpSumItemsWithDifferingQuantities = &allowLumpSumItemsWithDifferingQuantities
	return r
}
...
// Defaults to &#39;false&#39;. By default, the GAEB standard requires lump sum items (&#39;Pauschalpositionen&#39; in German) to have a quantity of exactly 1. AVACloud does enforce this convention, but if you set this property to &#39;true&#39;, then differing quantities will be kept during the import.
func (r ApiGaebConversionConvertToOenormRequest) AllowLumpSumItemsWithDifferingQuantities(allowLumpSumItemsWithDifferingQuantities bool) ApiGaebConversionConvertToOenormRequest {
	r.allowLumpSumItemsWithDifferingQuantities = &allowLumpSumItemsWithDifferingQuantities
	return r
}

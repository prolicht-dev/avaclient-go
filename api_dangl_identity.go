...
type ApiDanglIdentityGetUserInfoRequest struct {
	ctx        context.Context
	ApiService *DanglIdentityApiService
}

func (r ApiDanglIdentityGetUserInfoRequest) Execute() (*UserInfoGet, *http.Response, error) {
	return r.ApiService.DanglIdentityGetUserInfoExecute(r)
}

/*
DanglIdentityGetUserInfo Method for DanglIdentityGetUserInfo

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiDanglIdentityGetUserInfoRequest
*/
func (a *DanglIdentityApiService) DanglIdentityGetUserInfo(ctx context.Context) ApiDanglIdentityGetUserInfoRequest {
	return ApiDanglIdentityGetUserInfoRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return UserInfoGet
func (a *DanglIdentityApiService) DanglIdentityGetUserInfoExecute(r ApiDanglIdentityGetUserInfoRequest) (*UserInfoGet, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *UserInfoGet
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DanglIdentityApiService.DanglIdentityGetUserInfo")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/identity/user-info"

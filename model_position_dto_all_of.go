...
// checks if the PositionDtoAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PositionDtoAllOf{}
...
func (o PositionDtoAllOf) MarshalJSON() ([]byte, error) {
...
func (o PositionDtoAllOf) ToMap() (map[string]interface{}, error) {
...
type NullablePositionDtoAllOf struct {
	value *PositionDtoAllOf
	isSet bool
}

func (v NullablePositionDtoAllOf) Get() *PositionDtoAllOf {
	return v.value
}

func (v *NullablePositionDtoAllOf) Set(val *PositionDtoAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullablePositionDtoAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullablePositionDtoAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePositionDtoAllOf(val *PositionDtoAllOf) *NullablePositionDtoAllOf {
	return &NullablePositionDtoAllOf{value: val, isSet: true}
}

func (v NullablePositionDtoAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePositionDtoAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
